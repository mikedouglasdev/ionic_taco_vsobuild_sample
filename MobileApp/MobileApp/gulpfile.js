...
gulp.task("default", ["copyRelease"], function () {
    var email = process.env.IONIC_EMAIL;
    var password = args.password;
    gr('ionic upload --email ' + email + ' --password ' + password).exec()
});

gulp.task("copyRelease", ["package"], function () {
